...
import lib.org.apache.xml.security.exceptions.Base64DecodingException;
...
import lib.org.apache.xml.security.transforms.params.InclusiveNamespaces;
...
public class Reference extends SignatureElementProxy {
	...
	public Reference(Document doc, String BaseURI, String ReferenceURI, Manifest manifest, Transforms transforms, String messageDigestAlgorithm, byte[] hash)
	throws XMLSignatureException{
		super(doc);
		...
		}
		{
			...
			this.digested = true;
			this.setDigestValueElement(hash);
		}
	}
