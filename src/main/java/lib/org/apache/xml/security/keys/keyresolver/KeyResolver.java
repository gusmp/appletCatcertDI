...
public class KeyResolver {
    ...
    * available to <I>all</I> {@link lib.org.apache.xml.security.keys.KeyInfo} objects. This means that
    * personalized {@link KeyResolverSpi}s should only be registered directly
    * to the {@link lib.org.apache.xml.security.keys.KeyInfo} using 
    * {@link lib.org.apache.xml.security.keys.KeyInfo#registerInternalKeyResolver}.
    *
    * @param className
 * @throws InstantiationException 
 * @throws IllegalAccessException 
 * @throws ClassNotFoundException 
    ...
    * available to <I>all</I> {@link lib.org.apache.xml.security.keys.KeyInfo} objects. This means that
    * personalized {@link KeyResolverSpi}s should only be registered directly
    * to the {@link lib.org.apache.xml.security.keys.KeyInfo} using {@link lib.org.apache.xml.security.keys.KeyInfo#registerInternalKeyResolver}.
    *
    * @param className
    */
