 ...
 *
 */
package lib.org.apache.xml.security.keys.storage.implementations;
...
import lib.org.apache.xml.security.keys.storage.StorageResolverException;
import lib.org.apache.xml.security.keys.storage.StorageResolverSpi;



/**
 * Makes the Certificates from a JAVA {@link KeyStore} object available to the
 * {@link lib.org.apache.xml.security.keys.storage.StorageResolver}.
 *
 * @author $Author: raul $
 */
public class KeyStoreResolver extends StorageResolverSpi {
   ...
   public static void main(String unused[]) throws Exception {
      ...
      for (Iterator i = krs.getIterator(); i.hasNext(); ) {
         ...
         byte[] ski =
            lib.org.apache.xml.security.keys.content.x509.XMLX509SKI
               .getSKIBytesFromCert(cert);

         System.out.println(lib.org.apache.xml.security.utils.Base64.encode(ski));
      }
   }
}
