...
import lib.org.apache.xml.security.utils.SignerOutputStream;
...
public final class XMLSignature extends SignatureElementProxy {
  ...
  /**
   ...
   public void setSignatureValueId(String identifier) {
	   if (this._state == MODE_SIGN && identifier != null) {
	         Element signatureValueElem = XMLUtils.selectDsNode(this._constructionElement.getFirstChild(),
	                                         Constants._TAG_SIGNATUREVALUE,0);
	         signatureValueElem.setAttribute("Id", identifier);
	   }
   }
    ...
    */
   public void addDocument(
           String referenceURI, Transforms trans, String digestURI, String ReferenceId, String ReferenceType, byte[] hash)
              throws XMLSignatureException {
      this._signedInfo.addDocument(this._baseURI, referenceURI, trans,
                                   digestURI, ReferenceId, ReferenceType, hash);
   }
