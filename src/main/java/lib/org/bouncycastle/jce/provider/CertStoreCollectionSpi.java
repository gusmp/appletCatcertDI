...
public class CertStoreCollectionSpi extends CertStoreSpi
{
        ...
        throws InvalidAlgorithmParameterException
    {
        ...
        {
            throw new InvalidAlgorithmParameterException("lib.org.bouncycastle.jce.provider.CertStoreCollectionSpi: parameter must be a CollectionCertStoreParameters object\n" +  params.toString());
        }
