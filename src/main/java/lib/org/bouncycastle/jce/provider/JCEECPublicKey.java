...
import lib.org.bouncycastle.asn1.cryptopro.ECGOST3410NamedCurves;
import lib.org.bouncycastle.asn1.cryptopro.GOST3410PublicKeyAlgParameters;
...
import lib.org.bouncycastle.jce.ECGOST3410NamedCurveTable;
import lib.org.bouncycastle.jce.interfaces.ECPointEncoder;
import lib.org.bouncycastle.jce.provider.asymmetric.ec.EC5Util;
import lib.org.bouncycastle.jce.provider.asymmetric.ec.ECUtil;
import lib.org.bouncycastle.jce.spec.ECNamedCurveParameterSpec;
import lib.org.bouncycastle.jce.spec.ECNamedCurveSpec;
    ...
    implements ECPublicKey, lib.org.bouncycastle.jce.interfaces.ECPublicKey, ECPointEncoder
{
    ...
    private lib.org.bouncycastle.math.ec.ECPoint q;
        ...
        lib.org.bouncycastle.jce.spec.ECPublicKeySpec     spec)
    {
        ...
        else
        {
            if (q.getCurve() == null)
            {
                lib.org.bouncycastle.jce.spec.ECParameterSpec s = ProviderUtil.getEcImplicitlyCa();
    ...
    public lib.org.bouncycastle.math.ec.ECPoint getQ()
    {
        if (ecSpec == null)
        {
            if (q instanceof lib.org.bouncycastle.math.ec.ECPoint.Fp)
            {
                return new lib.org.bouncycastle.math.ec.ECPoint.Fp(null, q.getX(), q.getY());
            }
            else
            {
                return new lib.org.bouncycastle.math.ec.ECPoint.F2m(null, q.getX(), q.getY());
            }
        }
    ...
    public lib.org.bouncycastle.math.ec.ECPoint engineGetQ()
    {
        return q;
    }
