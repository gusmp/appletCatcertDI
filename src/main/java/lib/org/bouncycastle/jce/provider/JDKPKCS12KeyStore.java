...
import lib.org.bouncycastle.asn1.BERConstructedOctetString;
import lib.org.bouncycastle.asn1.BEROutputStream;
import lib.org.bouncycastle.asn1.DERBMPString;
...
import lib.org.bouncycastle.asn1.pkcs.AuthenticatedSafe;
import lib.org.bouncycastle.asn1.pkcs.CertBag;
import lib.org.bouncycastle.asn1.pkcs.ContentInfo;
import lib.org.bouncycastle.asn1.pkcs.EncryptedData;
import lib.org.bouncycastle.asn1.pkcs.MacData;
import lib.org.bouncycastle.asn1.pkcs.PKCS12PBEParams;
import lib.org.bouncycastle.asn1.pkcs.PKCSObjectIdentifiers;
import lib.org.bouncycastle.asn1.pkcs.Pfx;
import lib.org.bouncycastle.asn1.pkcs.SafeBag;
import lib.org.bouncycastle.asn1.util.ASN1Dump;
...
import lib.org.bouncycastle.asn1.x509.SubjectKeyIdentifier;
...
import lib.org.bouncycastle.jce.interfaces.BCKeyStore;
import lib.org.bouncycastle.jce.interfaces.PKCS12BagAttributeCarrier;
import lib.org.bouncycastle.util.Arrays;
import lib.org.bouncycastle.util.Strings;
import lib.org.bouncycastle.util.encoders.Hex;
    ...
    implements PKCSObjectIdentifiers, X509ObjectIdentifiers, BCKeyStore
{
            ...
            for (int i = 0; i != c.length; i++)
            {
                if (c[i].getContentType().equals(data))
                {
                    ...
                    for (int j = 0; j != seq.size(); j++)
                    {
                        ...
                        {
                            lib.org.bouncycastle.asn1.pkcs.EncryptedPrivateKeyInfo eIn = new lib.org.bouncycastle.asn1.pkcs.EncryptedPrivateKeyInfo((ASN1Sequence)b.getBagValue());
                ...
                else if (c[i].getContentType().equals(encryptedData))
                {
                    ...
                    for (int j = 0; j != seq.size(); j++)
                    {
                        ...
                        {
                            lib.org.bouncycastle.asn1.pkcs.PrivateKeyInfo pIn = new lib.org.bouncycastle.asn1.pkcs.PrivateKeyInfo((ASN1Sequence)b.getBagValue());
        ...
        throws IOException
    {
        ...
        while (ks.hasMoreElements())
        {
            ...
            lib.org.bouncycastle.asn1.pkcs.EncryptedPrivateKeyInfo kInfo = new lib.org.bouncycastle.asn1.pkcs.EncryptedPrivateKeyInfo(kAlgId, kBytes);
