...
import lib.org.bouncycastle.asn1.cmp.PKIFailureInfo;
    ...
    implements X509Extension
{
    ...
    */
    ...
    public byte[] getExtensionValue(String oid)
    {
        ...
        if (exts != null)
        {
            lib.org.bouncycastle.asn1.x509.X509Extension   ext = exts.getExtension(new DERObjectIdentifier(oid));
        ...
        boolean critical)
    {
        ...
        if (extensions != null)
        {
            ...
            while (e.hasMoreElements())
            {
                ...
                lib.org.bouncycastle.asn1.x509.X509Extension ext = extensions.getExtension(oid);
