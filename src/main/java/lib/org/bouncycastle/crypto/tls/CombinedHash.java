...
public class CombinedHash implements Digest
{
    ...
    /**
     * @see lib.org.bouncycastle.crypto.Digest#getAlgorithmName()
     */
    ...
    /**
     * @see lib.org.bouncycastle.crypto.Digest#getDigestSize()
     */
    ...
    /**
     * @see lib.org.bouncycastle.crypto.Digest#update(byte)
     */
    ...
    /**
     * @see lib.org.bouncycastle.crypto.Digest#update(byte[],int,int)
     */
    ...
    /**
     * @see lib.org.bouncycastle.crypto.Digest#doFinal(byte[],int)
     */
    ...
    /**
     * @see lib.org.bouncycastle.crypto.Digest#reset()
     */
    public void reset()
    {
        md5.reset();
