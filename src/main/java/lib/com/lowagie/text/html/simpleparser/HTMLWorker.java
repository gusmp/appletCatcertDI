...
package lib.com.lowagie.text.html.simpleparser;
...
import lib.com.lowagie.text.ElementTags;
import lib.com.lowagie.text.ExceptionConverter;
import lib.com.lowagie.text.FontFactoryImp;
...
import lib.com.lowagie.text.TextElementArray;
import lib.com.lowagie.text.html.HtmlTags;
import lib.com.lowagie.text.html.Markup;
import lib.com.lowagie.text.pdf.PdfPTable;
import lib.com.lowagie.text.xml.simpleparser.SimpleXMLDocHandler;
import lib.com.lowagie.text.xml.simpleparser.SimpleXMLParser;
	...
	public void startElement(String tag, HashMap h) {
		...
		try {
			...
			if (tag.equals(HtmlTags.UNORDEREDLIST)) {
				...
				skipText = true;
				cprops.addToChain(tag, h);
				lib.com.lowagie.text.List list = new lib.com.lowagie.text.List(false,
						10);
				list.setListSymbol("\u2022");
				stack.push(list);
				return;
			...
			if (tag.equals(HtmlTags.ORDEREDLIST)) {
				...
				skipText = true;
				cprops.addToChain(tag, h);
				lib.com.lowagie.text.List list = new lib.com.lowagie.text.List(true, 10);
				stack.push(list);
				return;
			}
		...
		try {
			...
			if (tag.equals(HtmlTags.UNORDEREDLIST)
				...
				if (stack.empty())
					return;
				Object obj = stack.pop();
				if (!(obj instanceof lib.com.lowagie.text.List)) {
					stack.push(obj);
					return;
				}
				if (stack.empty())
			...
			if (tag.equals(HtmlTags.LISTITEM)) {
				...
				if (!(list instanceof lib.com.lowagie.text.List)) {
					stack.push(list);
					return;
				}
				ListItem item = (ListItem) obj;
				((lib.com.lowagie.text.List) list).add(item);
