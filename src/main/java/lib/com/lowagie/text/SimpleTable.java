...
import lib.com.lowagie.text.pdf.PdfPTableEvent;
...
public class SimpleTable extends Rectangle implements PdfPTableEvent, TextElementArray {
	 ...
	 * @return a lib.com.lowagie.text.Table object
	 * @throws BadElementException
	 */
	 ...
	 * @return a lib.com.lowagie.text.pdf.PdfPTable object
	...
	/**
     * @see lib.com.lowagie.text.pdf.PdfPTableEvent#tableLayout(lib.com.lowagie.text.pdf.PdfPTable, float[][], float[], int, int, lib.com.lowagie.text.pdf.PdfContentByte[])
 	 */
	...
	/**
	 * @see lib.com.lowagie.text.TextElementArray#add(java.lang.Object)
	 */
