    ...
    protected int goComposite(boolean simulate) throws DocumentException {
        ...
        while (true) {
            ...
            if (element.type() == Element.PARAGRAPH) {
                ...
                lib.com.lowagie.text.List list = (lib.com.lowagie.text.List)element;
                ...
                for (int k = 0; k < items.size(); ++k) {
                    ...
                    else if (obj instanceof lib.com.lowagie.text.List) {
                        stack.push(new Object[]{list, new Integer(k), new Float(listIndentation)});
                        list = (lib.com.lowagie.text.List)obj;
                        items = list.getItems();
                    ...
                    if (k == items.size() - 1) {
                        if (!stack.isEmpty()) {
                            ...
                            list = (lib.com.lowagie.text.List)objs[0];
                            items = list.getItems();
