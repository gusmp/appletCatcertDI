/*
 * $Id: PdfWriter.java 3538 2008-07-08 13:08:04Z blowagie $
 *
...
import lib.com.lowagie.text.DocListener;
import lib.com.lowagie.text.DocWriter;
import lib.com.lowagie.text.Document;
import lib.com.lowagie.text.DocumentException;
import lib.com.lowagie.text.ExceptionConverter;
import lib.com.lowagie.text.Image;
import lib.com.lowagie.text.ImgWMF;
import lib.com.lowagie.text.Rectangle;
import lib.com.lowagie.text.Table;
import lib.com.lowagie.text.pdf.collection.PdfCollection;
import lib.com.lowagie.text.pdf.events.PdfPageEventForwarder;
import lib.com.lowagie.text.pdf.interfaces.PdfAnnotations;
import lib.com.lowagie.text.pdf.interfaces.PdfDocumentActions;
import lib.com.lowagie.text.pdf.interfaces.PdfEncryptionSettings;
import lib.com.lowagie.text.pdf.interfaces.PdfPageActions;
import lib.com.lowagie.text.pdf.interfaces.PdfRunDirection;
import lib.com.lowagie.text.pdf.interfaces.PdfVersion;
import lib.com.lowagie.text.pdf.interfaces.PdfViewerPreferences;
import lib.com.lowagie.text.pdf.interfaces.PdfXConformance;
import lib.com.lowagie.text.pdf.internal.PdfVersionImp;
import lib.com.lowagie.text.pdf.internal.PdfXConformanceImp;
import lib.com.lowagie.text.xml.xmp.XmpWriter;
...
//	Open and Close methods + method that create the PDF
     ...
     * @see lib.com.lowagie.text.DocWriter#open()
     */
    public void open() {
        super.open();
        try {
     ...
     * @see lib.com.lowagie.text.DocWriter#close()
     */
    public void close() {
        if (open) {
...
//	[C2] PdfVersion interface
    ...
    /** @see lib.com.lowagie.text.pdf.interfaces.PdfVersion#setPdfVersion(char) */
    public void setPdfVersion(char version) {
        pdf_version.setPdfVersion(version);
    }
    
    /** @see lib.com.lowagie.text.pdf.interfaces.PdfVersion#setAtLeastPdfVersion(char) */
    public void setAtLeastPdfVersion(char version) {
    	pdf_version.setAtLeastPdfVersion(version);
    }

	/** @see lib.com.lowagie.text.pdf.interfaces.PdfVersion#setPdfVersion(lib.com.lowagie.text.pdf.PdfName) */
...
//  [C3] PdfViewerPreferences interface
    ...
    /** @see lib.com.lowagie.text.pdf.interfaces.PdfViewerPreferences#setViewerPreferences(int) */
    public void setViewerPreferences(int preferences) {
        pdf.setViewerPreferences(preferences);
    }

    /** @see lib.com.lowagie.text.pdf.interfaces.PdfViewerPreferences#addViewerPreference(lib.com.lowagie.text.pdf.PdfName, lib.com.lowagie.text.pdf.PdfObject) */
...
// [C6] Actions (open and additional)
    ...
    /** @see lib.com.lowagie.text.pdf.interfaces.PdfDocumentActions#setOpenAction(java.lang.String) */
    public void setOpenAction(String name) {
         pdf.setOpenAction(name);
     }

    /** @see lib.com.lowagie.text.pdf.interfaces.PdfDocumentActions#setOpenAction(lib.com.lowagie.text.pdf.PdfAction) */
    public void setOpenAction(PdfAction action) {
         pdf.setOpenAction(action);
     }
     
    /** @see lib.com.lowagie.text.pdf.interfaces.PdfDocumentActions#setAdditionalAction(lib.com.lowagie.text.pdf.PdfName, lib.com.lowagie.text.pdf.PdfAction) */
...
//	[C8] AcroForm
    ...
    /** @see lib.com.lowagie.text.pdf.interfaces.PdfAnnotations#getAcroForm() */
    public PdfAcroForm getAcroForm() {
        return pdf.getAcroForm();
    }
    
    /** @see lib.com.lowagie.text.pdf.interfaces.PdfAnnotations#addAnnotation(lib.com.lowagie.text.pdf.PdfAnnotation) */
    ...
    /** @see lib.com.lowagie.text.pdf.interfaces.PdfAnnotations#addCalculationOrder(lib.com.lowagie.text.pdf.PdfFormField) */
    public void addCalculationOrder(PdfFormField annot) {
        pdf.addCalculationOrder(annot);
    }
    
    /** @see lib.com.lowagie.text.pdf.interfaces.PdfAnnotations#setSigFlags(int) */
...
//	[C10] PDFX Conformance
    ...
    /** @see lib.com.lowagie.text.pdf.interfaces.PdfXConformance#setPDFXConformance(int) */
    ...
    /** @see lib.com.lowagie.text.pdf.interfaces.PdfXConformance#getPDFXConformance() */
    public int getPDFXConformance() {
        return pdfxConformance.getPDFXConformance();
    }
    
    /** @see lib.com.lowagie.text.pdf.interfaces.PdfXConformance#isPdfX() */
...
//	[F1] PdfEncryptionSettings interface
    ...
    /** @see lib.com.lowagie.text.pdf.interfaces.PdfEncryptionSettings#setEncryption(byte[], byte[], int, int) */
    ...
    /** @see lib.com.lowagie.text.pdf.interfaces.PdfEncryptionSettings#setEncryption(java.security.cert.Certificate[], int[], int) */
...
//  [U3] page actions (open and close)
    ...
    /** @see lib.com.lowagie.text.pdf.interfaces.PdfPageActions#setPageAction(lib.com.lowagie.text.pdf.PdfName, lib.com.lowagie.text.pdf.PdfAction) */
    ...
    /** @see lib.com.lowagie.text.pdf.interfaces.PdfPageActions#setDuration(int) */
    public void setDuration(int seconds) {
         pdf.setDuration(seconds);
     }
     
    /** @see lib.com.lowagie.text.pdf.interfaces.PdfPageActions#setTransition(lib.com.lowagie.text.pdf.PdfTransition) */
...
//	[U4] Thumbnail image
     ...
     */    
    public void setThumbnail(Image image) throws PdfException, DocumentException, BadPdfFormatException {
...
//	[M3] Images
     ...
     * @throws BadPdfFormatException 
     */
    public PdfName addDirectImageSimple(Image image) throws PdfException, DocumentException, BadPdfFormatException {
     ...
     * @throws BadPdfFormatException 
     */
    public PdfName addDirectImageSimple(Image image, PdfIndirectReference fixedRef) throws PdfException, DocumentException, BadPdfFormatException {
        PdfName name;
