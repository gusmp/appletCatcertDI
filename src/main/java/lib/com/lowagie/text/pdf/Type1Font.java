...
import lib.com.lowagie.text.pdf.fonts.FontsResourceAnchor;
    ...
    Type1Font(String afmFile, String enc, boolean emb, byte ttfAfm[], byte pfb[]) throws DocumentException, IOException
    {
        ...
        if (BuiltinFonts14.containsKey(afmFile)) {
            ...
            try {
                ...
                if (is == null) {
                    String msg = afmFile + " not found as resource. (The *.afm files must exist as resources in the package lib.com.lowagie.text.pdf.fonts)";
