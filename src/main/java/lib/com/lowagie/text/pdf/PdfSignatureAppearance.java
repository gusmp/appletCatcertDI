...
public class PdfSignatureAppearance {
    ...
    */    
    ...
    public PdfTemplate getAppearance() throws DocumentException {
        ...
        if (app[2] == null) {
            ...
            if (layer2Text == null) {
                ...
                buf.append("Signat electrònicament per ").append(PdfPKCS7.getSubjectFields((X509Certificate)certChain[0]).getField("CN")).append('\n');
                SimpleDateFormat sd = new SimpleDateFormat("yyyy.MM.dd HH:mm:ss z");
                buf.append("Date: ").append(sd.format(signDate.getTime()));
                if (reason != null)
                    buf.append('\n').append("Raó: ").append(reason);
                if (location != null)
                    buf.append('\n').append("Lloc: ").append(location);
                text = buf.toString();
            }
            else
                text = layer2Text;
     ...
     */    
    public lib.com.lowagie.text.pdf.PdfName getFilter() {
        return filter;
    }
     ...
     */    
    public lib.com.lowagie.text.Rectangle getPageRect() {
        return pageRect;
    }
    ...
    lib.com.lowagie.text.pdf.ByteBuffer getSigout() {
        return sigout;
    }
    
    void setSigout(lib.com.lowagie.text.pdf.ByteBuffer sigout) {
        this.sigout = sigout;
    }
     ...
     */    
    public lib.com.lowagie.text.pdf.PdfDictionary getCryptoDictionary() {
     ...
     */    
    public void setCryptoDictionary(lib.com.lowagie.text.pdf.PdfDictionary cryptoDictionary) {
     ...
     */    
    public lib.com.lowagie.text.pdf.PdfStamper getStamper() {
        return stamper;
    }
    
    void setStamper(lib.com.lowagie.text.pdf.PdfStamper stamper) {
     ...
     */    
    public lib.com.lowagie.text.pdf.PdfSigGenericPKCS getSigStandard() {
        return sigStandard;
    }
