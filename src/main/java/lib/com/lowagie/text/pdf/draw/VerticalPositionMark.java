...
package lib.com.lowagie.text.pdf.draw;
...
import lib.com.lowagie.text.ElementListener;
...
public class VerticalPositionMark implements DrawInterface, Element {
	...
	/**
	 * @see lib.com.lowagie.text.pdf.draw.DrawInterface#draw(lib.com.lowagie.text.pdf.PdfContentByte, float, float, float, float, float)
	 */
    ...
    /**
     * @see lib.com.lowagie.text.Element#process(lib.com.lowagie.text.ElementListener)
     */
    ...
    /**
     * @see lib.com.lowagie.text.Element#type()
     */
    public int type() {
    ...
    /**
     * @see lib.com.lowagie.text.Element#isContent()
     */
    ...
    /**
     * @see lib.com.lowagie.text.Element#getChunks()
     */
