/*
 * $Id: PdfReader.java 3537 2008-07-08 08:53:00Z blowagie $
 *
...
import lib.org.bouncycastle.cms.CMSEnvelopedData;
import lib.org.bouncycastle.cms.RecipientInformation;
...
public class PdfReader implements PdfViewerPreferences {
    ...
    private void readDecryptedDocObj() throws IOException {
        ...
        if (documentIDs != null) {
            ...
            strings.remove(o);
            s = o.toString();
            documentID = lib.com.lowagie.text.DocWriter.getISOBytes(s);
        ...
        {        	        
            ...
            uValue = lib.com.lowagie.text.DocWriter.getISOBytes(s);
            s = enc.get(PdfName.O).toString();
            strings.remove(enc.get(PdfName.O));
            oValue = lib.com.lowagie.text.DocWriter.getISOBytes(s);
