 ...
 * <P>
 * When using variable borders ({@link lib.com.lowagie.text.Rectangle#isUseVariableBorders isUseVariableBorders()} == true),
 ...
 * cells.
 *
 * @see		lib.com.lowagie.text.Rectangle
 * @see		lib.com.lowagie.text.Cell
 * @see		PdfLine
 * @see		PdfTable
 */
...
public class PdfCell extends Rectangle {
     ...
     * @param side the side to check.  One of the side constants in {@link lib.com.lowagie.text.Rectangle}
