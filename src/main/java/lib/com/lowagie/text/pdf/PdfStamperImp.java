...
import lib.com.lowagie.text.xml.xmp.XmpReader;
...
//        reader.getCatalog().remove(PdfName.ACROFORM);
    ...
    /**
     * @see lib.com.lowagie.text.pdf.PdfWriter#getPageReference(int)
     */
    ...
    /**
     * @see lib.com.lowagie.text.pdf.PdfWriter#addAnnotation(lib.com.lowagie.text.pdf.PdfAnnotation)
     */
    ...
    /**
     * @see lib.com.lowagie.text.pdf.PdfWriter#setOpenAction(lib.com.lowagie.text.pdf.PdfAction)
     */
    ...
    /**
     * @see lib.com.lowagie.text.pdf.PdfWriter#setOpenAction(java.lang.String)
     */
    ...
    /**
     * @see lib.com.lowagie.text.pdf.PdfWriter#setThumbnail(lib.com.lowagie.text.Image)
     */
    public void setThumbnail(lib.com.lowagie.text.Image image) {
        throw new UnsupportedOperationException("Use PdfStamper.setThumbnail().");
    }
    
    void setThumbnail(Image image, int page) throws PdfException, DocumentException, BadPdfFormatException {
